  ...
  en: {
    translation: {
      ...
      payment: {
        ...
        creditCardInfo: "Enter your credit card details",
        secureProcessing: "Your payment information is processed securely. We do not store your credit card details.",
        ...
        orderProcessingError: "Payment was successful, but there was an error processing your order.",
        secureCheckout: "Secure Checkout",
        success: "Payment Success",
        paymentSuccessful: "Payment Successful!",
        thankYouMessage: "Thank you for your order. Your payment has been processed successfully.",
  ...
  ar: {
    translation: {
      ...
      payment: {
        ...
        creditCardInfo: "أدخل تفاصيل بطاقة الائتمان الخاصة بك",
        secureProcessing: "تتم معالجة معلومات الدفع الخاصة بك بشكل آمن. نحن لا نخزن تفاصيل بطاقة الائتمان الخاصة بك.",
        processingError: "حدث خطأ أثناء معالجة الدفع الخاص بك. الرجاء المحاولة مرة أخرى.",
        failed: "فشل الدفع. الرجاء تجربة طريقة دفع أخرى.",
        orderProcessingError: "تم الدفع بنجاح، ولكن حدث خطأ في معالجة طلبك.",
        secureCheckout: "الدفع الآمن",
        success: "نجاح الدفع",
        paymentSuccessful: "تم الدفع بنجاح!",
        thankYouMessage: "شكرا لطلبك. تمت معالجة دفعتك بنجاح.",
        viewOrders: "عرض طلبياتي",
